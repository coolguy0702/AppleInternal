...
ETLTool ping
ETLTool ping
echo "============= MRU_Write_VZW Begin ==============" >> nvwritelog.txt
date >> nvwritelog.txt
echo "[ Before Write ] " >> nvwritelog.txt
ETLTool nvread 945 >> nvwritelog.txt
ETLTool nvwrite 945 0 2 0 80 01 28 00 ff ff 28

ETLTool ping
ETLTool efs-get prim /sd/mru001 264 >> nvwritelog.txt
ETLTool ping
ETLTool efs-put prim /sd/mru001 777 0a 13 01 84 00 00 00 00 00 00 ff 00 1f 00 ff 3f 01 09 01 09 00 00 02 00 80 01 28 00 06 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00 24 02 40 00 fa 00 00 00 ff 00 1f 00 ff 3f 01 09 01 09 00 00 02 00 fb 01 28 00 fa 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00 a9 01 28 00 06 00 00 00 00 00 00 00 00 00 00 00 00 10 00 00 02 00 d2 01 40 00 fa 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 >> nvwritelog.txt 
...
ETLTool ping
ETLTool efs-get prim /sd/mru001 264 >> nvwritelog.txt
echo "============= MRU_Write_VZW END ==============" >> nvwritelog.txt
cat nvwritelog.txt >> MRU_Write_VZW.txt
cat nvwritelog.txt
