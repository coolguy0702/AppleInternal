...
ETLTool ping
ETLTool ping
echo "============= MRU_Write_DRA Begin ==============" >> nvwritelog.txt
date >> nvwritelog.txt
...
ETLTool ping
ETLTool efs-put prim /sd/mru001 777 02 00 1B 11 28 00 06 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00 C9 00 40 00 fa 00 00 00 ff 00 1f 00 ff 3f 01 09 01 09 00 00 02 00 F2 00 28 00 fa 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00 90 00 28 00 06 00 00 00 00 00 00 00 00 00 00 00 00 10 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  >> nvwritelog.txt 
...
ETLTool ping
ETLTool efs-get prim /sd/mru001 264 >> nvwritelog.txt
echo "============= MRU_Write_DRA END ==============" >> nvwritelog.txt
cat nvwritelog.txt >> MRU_Write_DRA.txt
cat nvwritelog.txt
