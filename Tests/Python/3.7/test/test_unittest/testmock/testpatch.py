...
import unittest
from . import support
from .support import SomeClass, is_instance
...
class PatchTest(unittest.TestCase):
    ...
    def test_patch_dict_decorator_resolution(self):
        ...
        @patch.dict(__package__ + '.support.target', {'bar': 'BAR'})
        def test():
    ...
    def test_patch_nested_autospec_repr(self):
        with patch(__package__ + '.support', autospec=True) as m:
    ...
    def test_special_attrs(self):
        ...
        self.assertEqual(foo.__module__, __package__ + '.testpatch')
