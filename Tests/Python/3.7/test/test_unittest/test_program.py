...
class Test_TestProgram(unittest.TestCase):
    ...
    def test_discovery_from_dotted_path(self):
        ...
        tests = [self]
        expectedPath = os.path.abspath(os.path.dirname(sys.modules[__package__].__file__))
        ...
        suite = loader.discover(__package__)
    ...
    def test_defaultTest_with_string(self):
        ...
        program = unittest.TestProgram(testRunner=runner, exit=False,
                                       defaultTest=__package__,
                                       testLoader=self.FooBarLoader())
        sys.argv = old_argv
        self.assertEqual((__package__,), program.testNames)
    ...
    def test_defaultTest_with_iterable(self):
        ...
        program = unittest.TestProgram(
            ...
            defaultTest=[__package__, __package__ + '2'],
            testLoader=self.FooBarLoader())
        sys.argv = old_argv
        self.assertEqual([__package__, __package__ + '2'],
                          program.testNames)
