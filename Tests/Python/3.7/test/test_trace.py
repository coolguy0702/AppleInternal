...
class TestCoverage(unittest.TestCase):
    ...
    def test_coverage_ignore(self):
        #this is exclusing the stdlib based on sys.base_prefix, which won't work
        #if we've put the test files somewhere else.
        if not __file__.startswith(sys.base_prefix):
            raise unittest.SkipTest("tests are not under sys.base_prefix")
