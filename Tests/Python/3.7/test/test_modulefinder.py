...
class ModuleFinderTest(unittest.TestCase):
    def _do_test(self, info, report=False, debug=0, replace_paths=[]):
        ...
        # modulefinder uses the deprecated 'imp' library instead of 'importlib',
        # It cannot handle the zipimporter case or anything similar.
        from importlib.abc import SourceLoader
        from importlib.util import find_spec
        if not isinstance(find_spec("__future__").loader, SourceLoader):
