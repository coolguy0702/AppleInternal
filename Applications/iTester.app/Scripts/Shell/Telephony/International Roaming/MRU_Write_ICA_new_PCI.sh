...
do
        case "$OPTION" in
                h ) echo "Usage: ./MRU_Write_ICA.sh"; exit 1;;
...
ETLTool ping
ETLTool efs-put prim /sd/mru001 777 02 01 5E 01 28 00 06 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 01 EE 02 40 00 fa 00 00 00 ff 00 1f 00 ff 3f 01 09 01 09 00 00 02 01 77 01 28 00 fa 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00 A9 01 28 00 06 00 00 00 00 00 00 00 00 00 00 00 00 10 00 00 02 00 80 01 40 00 fa 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00 80 01 28 00 06 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 0a 13 01 84 ff ff ff ff ff ff ff 00 1f 00 ff 3f 01 09 01 09 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  >> nvwritelog.txt
...
ETLTool ping
ETLTool efs-get prim /sd/mru001 264 >> nvwritelog.txt
echo "============= MRU_Write_ICA END ==============" >> nvwritelog.txt
